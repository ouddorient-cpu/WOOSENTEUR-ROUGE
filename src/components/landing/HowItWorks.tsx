...
const stepIcons = [
  { icon: <Sparkles className="h-6 w-6" />, color: 'from-violet-600 to-violet-500', glow: 'rgba(139,92,246,0.35)' },
  { icon: <Search className="h-6 w-6" />, color: 'from-indigo-600 to-indigo-500', glow: 'rgba(99,102,241,0.35)' },
  { icon: <Upload className="h-6 w-6" />, color: 'from-blue-600 to-blue-500', glow: 'rgba(59,130,246,0.35)' },
];

const HowItWorks = () => {
  const t = useT();
  const steps = [
    { ...stepIcons[0], step: 1, title: t.howitworks.step1.title, description: t.howitworks.step1.desc },
    { ...stepIcons[1], step: 2, title: t.howitworks.step2.title, description: t.howitworks.step2.desc },
    { ...stepIcons[2], step: 3, title: t.howitworks.step3.title, description: t.howitworks.step3.desc },
  ];
