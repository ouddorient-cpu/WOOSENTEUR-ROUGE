    ...
    <div className="container mx-auto px-4 md:px-6 relative z-10">
      ...
      >
        <p className="text-muted-foreground text-sm mb-5">
          Aucune carte bancaire · 5 fiches offertes · Résultat en 3 minutes
        </p>
        <Link href="/signup">
          <Button
            size="lg"
          ...
          >
            ...
            Générer ma fiche produit maintenant
