...
const TermsPage = () => {
  return (
    <>
      ...
      <p>
        Les présentes Conditions Générales d'Utilisation (CGU) ont pour objet de définir les modalités de mise à disposition du service WooSenteur (ci-après « le Service ») et les conditions d’utilisation du Service par l’Utilisateur.
      </p>
      ...
      <p>
        La structure générale du site WooSenteur, ainsi que les textes, graphiques, images, sons et vidéos la composant, sont la propriété de l'éditeur ou de ses partenaires. Toute représentation et/ou reproduction et/ou exploitation partielle ou totale des contenus et services proposés par le site WooSenteur, par quelque procédé que ce soit, sans l'autorisation préalable et par écrit de l'éditeur est strictement interdite et serait susceptible de constituer une contrefaçon au sens des articles L 335-2 et suivants du Code de la propriété intellectuelle.
      </p>
      <p>
      ...
      <p>
        L'Utilisateur reconnaît que la qualité du contenu généré par l'IA dépend des informations qu'il fournit. WooSenteur ne pourra être tenu responsable des inexactitudes ou du manque de pertinence du contenu généré si les données d'entrée sont erronées ou incomplètes.
      </p>
      
      <h2>Article 5 : Responsabilité de l'Éditeur</h2>
      <p>
        Le Service est fourni "en l'état" et "tel que disponible". WooSenteur ne garantit pas que le Service sera ininterrompu, exempt d'erreurs ou sécurisé. Une obligation de moyen pèse sur l'éditeur concernant l'accès et l'utilisation du service.
      </p>
      <p>
        La responsabilité de WooSenteur ne saurait être engagée en cas de force majeure ou du fait imprévisible et insurmontable d'un tiers.
      </p>
      ...
      <p>
        Les présentes CGU sont soumises au droit français. En cas de litige et à défaut d'accord amiable, le litige sera porté devant les tribunaux compétents de Meknès, Maroc.
      </p>
    </>
  );
};
