...
const PrivacyPage = () => {
  return (
    <>
      ...
      <p>
        La présente Politique de Confidentialité décrit la manière dont Woosenteur v2 (« nous », « notre » ou « nos ») collecte, utilise et divulgue vos informations personnelles lorsque vous utilisez notre site web (le « Service »).
      </p>
      ...
      <p>Woosenteur v2 utilise les données collectées pour diverses finalités :</p>
      <ul>
      ...
      <p>Pour exercer ces droits, veuillez nous contacter à l'adresse [Votre adresse e-mail de contact].</p>
      ...
      <p>
        Si vous avez des questions concernant cette Politique de Confidentialité, veuillez nous contacter : [Votre adresse e-mail de contact].
      </p>
    </>
  );
};
